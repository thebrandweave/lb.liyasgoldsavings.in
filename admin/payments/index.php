...
if (isset($_POST['action']) && isset($_POST['payment_id'])) {
    ...
    try {
        ...
        // Get payment details including promoter information and installment details
        $stmt = $conn->prepare("
    ...
    ");
        ...
        if ($newStatus === 'Verified') {
            $notificationMessage = "Your " . $payment['InstallmentNumber'] . " Installment payment of ₹" . number_format($payment['Amount'], 2) .
                " for " . $payment['SchemeName'] . " has been verified successfully.";
        } else {
...
<body>
    ...
    <script>
        ...
        function exportToExcel() {
            ...
            const exportUrl = `export_payments.php?search=${encodeURIComponent(search)}&status_filter=${encodeURIComponent(status)}&scheme_id=${encodeURIComponent(schemeId)}&installment=${encodeURIComponent(installment)}&start_date=${encodeURIComponent(startDate)}&end_date=${encodeURIComponent(endDate)}&promoter_id=${encodeURIComponent(promoterId)}`;
