...
if (isset($_POST['action']) && isset($_POST['withdrawal_id'])) {
    ...
    try {
        ...
        $smsMessage = "Dear " . $withdrawal['UserName'] . ", your withdrawal request of Rs " .
            number_format($withdrawal['Amount'], 0) . " has been " . strtolower($newStatus);
        if (!empty($adminRemark)) {
...
// Add this helper function near the top, after session and before any HTML output
