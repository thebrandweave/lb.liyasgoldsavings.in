...
foreach ($pendingPayments as $payment) {
    ...
    $sheet->setCellValue('D' . $row, $payment['PromoterID']);
    $sheet->setCellValue('E' . $row, $payment['SchemeName']);
    $sheet->setCellValue('F' . $row, $payment['InstallmentName'] . ' (#' . $payment['InstallmentNumber'] . ')');
    $sheet->setCellValue('G' . $row, $payment['InstallmentAmount']);
    $sheet->setCellValue('H' . $row, date('Y-m-d', strtotime($payment['DrawDate'])));
    $sheet->setCellValue('I' . $row, $payment['PaymentStatus']);
    $sheet->setCellValue('J' . $row, $payment['PaymentSubmittedAt'] ? date('Y-m-d', strtotime($payment['PaymentSubmittedAt'])) : '-');
