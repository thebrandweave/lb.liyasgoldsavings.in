...
$stmt = $db->prepare("
    SELECT s.*, sch.SchemeName, sch.MonthlyPayment, sch.StartDate AS SchemeStartDate, sch.TotalPayments
...
<head>
    ...
    <title>Schemes - Liyas Gold Savings</title>
                                ...
                                <tbody>
                                    <?php foreach ($activeSubscriptions as $subscription): ?>
                                        <tr>
                                            ...
                                            <td><?php echo date('M d, Y', strtotime($subscription['SchemeStartDate'])); ?></td>
                                            <td>
<?php
