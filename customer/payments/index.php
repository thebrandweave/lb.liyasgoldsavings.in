...
<head>
    ...
    <title>Payment History - Liyas Gold Savings</title>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            /* Tablet-friendly voucher layout (override base absolute positioning) */
            .voucher-right { min-width: 100% !important; max-width: 100% !important; padding: 8px 0 !important; justify-content: center !important; }
            .voucher-barcode { width: 160px !important; max-height: 130px !important; transform: none !important; }
            .voucher-redeem-note { position: static !important; white-space: normal !important; text-align: center !important; margin-top: 8px !important; }
            .voucher-brand { position: static !important; transform: none !important; text-align: center !important; margin-top: 4px !important; }
            .voucher-logo-center,
            .voucher-logo-gd,
            .voucher-logo-edu,
            .voucher-logo-btw { position: static !important; transform: none !important; width: 64px !important; height: 64px !important; display: inline-block !important; margin: 8px 8px 0 0 !important; }
            .voucher-logos { display: grid !important; grid-template-columns: repeat(2, 1fr) !important; gap: 10px !important; justify-items: center !important; margin-top: 8px !important; }
        ...
        @media (max-width: 576px) {
            ...
            /* Mobile-friendly voucher layout (force overrides) */
            .voucher-right { min-width: 100% !important; max-width: 100% !important; padding: 8px 0 !important; justify-content: center !important; }
            .voucher-barcode { width: 140px !important; max-height: 120px !important; transform: none !important; }
            .voucher-brand { position: static !important; transform: none !important; text-align: center !important; margin-top: 6px !important; }
            .voucher-redeem-note { position: static !important; white-space: normal !important; text-align: center !important; margin-top: 8px !important; }
            .voucher-left { align-items: center !important; text-align: center !important; }
            .voucher-title { text-align: center !important; }
            .voucher-logo-center,
            .voucher-logo-gd,
            .voucher-logo-edu,
            .voucher-logo-btw { position: static !important; transform: none !important; width: 56px !important; height: 56px !important; display: inline-block !important; margin: 6px 6px 0 0 !important; }
            .voucher-logos { display: grid !important; grid-template-columns: repeat(2, 1fr) !important; gap: 8px !important; justify-items: center !important; margin-top: 8px !important; }
        ...
        *, *::before, *::after {
        ...
        .voucher-card {
            ...
            background: -webkit-linear-gradient(to right,  #BA8B02, #181818);  /* Chrome 10-25, Safari 5.1-6 */
            background: linear-gradient(to right,  #BA8B02, #181818); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
            border-radius: 16px;
        ...
        @media (max-width: 768px) {
            ...
            .voucher-right { justify-content: flex-start; }
        }
    </style>
</head>
                    ...
                    <?php foreach ($payments as $payment): ?>
                        ...
                        <div class="voucher-card<?php echo $isLocked ? ' voucher-locked' : ''; ?>">
                            ...
                            <div class="voucher-center">
                                <div class="voucher-brand">Pro Gee Dee Ventures</div>
                                <div class="voucher-title">Gift <span>VOUCHER</span></div>
                                <div class="voucher-details">
                                    <div><b>Scheme:</b> <?php echo htmlspecialchars($payment['SchemeName']); ?></div>
                                    <div><b>Status:</b> <?php echo $payment['Status']; ?></div>
                                    <div><b>Date:</b> <?php echo date('M d, Y', strtotime($payment['SubmittedAt'])); ?></div>
                                </div>
                                <div class="voucher-desc">
                                    Thank you for your payment. Please keep this voucher for your records.
                                </div>
                                <div class="voucher-redeem-note">You can redeem this voucher at any of our partner brands shown here.</div>
                                <div class="voucher-logos">
                                    <img src="image/liyas_gold.png" alt="Liyas Gold and Diamond" class="voucher-logo-center">
                                    <img src="image/GD STORE LOGO-03 (1).jpg" alt="GD STORE" class="voucher-logo-gd">
                                    <img src="image/GD Edu Tech .png" alt="GD Edu Tech" class="voucher-logo-edu">
                                    <img src="image/WHITE BG RED WRITTEN (2).jpg" alt="BTW" class="voucher-logo-btw">
                                </div>
                            </div>
                            <div class="voucher-right">
                                <img src="image/bar_code.jpg" alt="Barcode" class="voucher-barcode">
                            </div>
                        </div>
                    <?php endforeach; ?>
                <?php endif; ?>
