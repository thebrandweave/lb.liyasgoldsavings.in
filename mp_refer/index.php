    ...
    try {
        ...
        if (empty($errors)) {
            ...
            if ($registrationType === 'customer') {
                ...
                // Send welcome SMS to customer using Airtel SMS API
                ...
                // Send WhatsApp welcome message to promoter
                $welcomeMessage = "🎉 Congratulations! 🎉\n\n$name\n\nYou are successfully registered on the Golden Dream Savings Plan. 🌟\n\n🆔 Your ID: $uniqueID\n🔑 Your Password: goldendream-25\n🔗 https://goldendream.in";
