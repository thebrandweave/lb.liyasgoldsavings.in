...
class SMSAPI
{
    ...
    public function sendWelcomeSMS($phoneNumber, $customerName, $customerUniqueID)
    {
        ...
        try {
            ...
            // Template: "Dear var, welcome to PROGEEDEE Ventures Private Limited. You have successfully registered for the Golden Dream Savings Plan. Your Customer ID is var. Visit http://localhost/la.goldendream.in// for more details."
            // Source Address: PGDVTR
            // Variables: var1 = Customer Name, var2 = Customer Unique ID

            $welcomeTemplate = "Dear {var1}, welcome to PROGEEDEE Ventures Private Limited. You have successfully registered for the Golden Dream Savings Plan. Your Customer ID is {var2}. Visit http://localhost/la.goldendream.in// for more details.";
