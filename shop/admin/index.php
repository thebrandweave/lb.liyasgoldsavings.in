...
<head>
    <meta charset="UTF-8">
    <title>Shop LA Admin Dashboard</title>
    ...
    <style>
        ...
        .dashboard-overview-card .card-icon {
            font-size: 1.3rem;
            margin-bottom: 6px;
        ...
        .dashboard-overview-card .card-value {
            color: var(--accent);
            font-size: 1.1rem;
            font-weight: 700;
            letter-spacing: 1px;
        ...
        .dashboard-top-products-card h3,
        .dashboard-recent-signups-card h3 {
            margin-top: 0;
        ...
        .dashboard-signups-list {
            list-style: none;
            padding: 0;
            margin: 0;
        }

        .dashboard-top-products-list li,
        .dashboard-signups-list li {
        ...
        .dashboard-orders-table tr:last-child {
            border-bottom: none;
        }
                ...
                <table class="dashboard-orders-table">
                    ...
                    <tbody>
                        ...
                        <?php if (empty($recentOrders)): ?>
                            <tr>
                                <td colspan="5" style="text-align:center; color:#aaa; padding:12px;">No recent orders</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
