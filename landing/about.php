...
<body>
    ...
    <section class="hero">
        <div class="container" style="display:flex;align-items:center;justify-content:space-between;gap:40px;">
            <div class="hero-text">
                ...
                <!-- <a href="http://localhost/la.goldendream.in///refer?id=GDP0001&ref=NTAw" class="btn">Start Your Journey</a> -->
            </div>
    ...
    <section class="cta">
        <div class="container">
            ...
            <!-- <a href="http://localhost/la.goldendream.in///refer?id=GDP0001&ref=NTAw" class="btn">Sign Up Now</a> -->
        </div>
    </section>
    ...
    <section class="registration-process" style="background:#f7f7fa; padding: 80px 0;">
        <div class="container" style="display:flex;align-items:center;justify-content:space-between;gap:40px;">
            <div style="flex:1.2;">
                ...
                <!-- <a href="http://localhost/la.goldendream.in///refer?id=GDP0001&ref=NTAw" class="btn" style="margin-top:12px;">Get started</a> -->
            </div>
